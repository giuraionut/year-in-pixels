...
export default function setGlobalColorTheme(
    ...
    const customTheme = {
        ...
        foreground: lightMode ? `${hue}  10% 3.9%` : "0 0% 95%",
        card: lightMode ? "0 0% 100%" : "24 9.8% 10%",
        cardForeground: lightMode ? `${hue} 10% 3.9%` : "0 0% 95%",
        popover: lightMode ? "0 0% 100%" : "0 0% 9%",
        popoverForeground: lightMode ? `${hue} 10% 3.9%` : "0 0% 95%",
        primary: `${hue ?? 0} 77.2% 49.8%`,
        primaryForeground: `${hue ?? 0} 100% 97.3%`,
        secondary: lightMode ? `${hue} 4.8% 95.9%` : `${hue} 3.7% 15.9%`,
        secondaryForeground: lightMode ? `${hue} 5.9% 10%` : "0 0% 98%",
        muted: lightMode ? `${hue} 4.8% 95.9%` : "0 0% 15%",
        mutedForeground: lightMode ? `${hue} 3.8% 46.1%` : `${hue} 5% 64.9%`,
        accent: lightMode ? `${hue} 4.8% 95.9%` : "12 6.5% 15.1%",
        accentForeground: lightMode ? `${hue} 5.9% 10%` : "0 0% 98%",
        destructive: lightMode ? "0 84.2% 60.2%" : "0 62.8% 30.6%",
        destructiveForeground: lightMode ? "0 0% 98%" : "0 85.7% 97.3%",
        border: lightMode ? `${hue} 5.9% 90%` : `${hue} 3.7% 15.9%`,
        input: lightMode ? `${hue} 5.9% 90%` : `${hue} 3.7% 15.9%`,
